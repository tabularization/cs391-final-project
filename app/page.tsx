...
export default function Home() {
  return (
    <div className="relative flex flex-col text-[#2E2E2E] h-full mt-30 items-center justify-start font-sans tracking-[-2px]">
      ...
      <h1 className="text-[3.5rem] font-[500] capitalize">Discover <span className="italic tracking-[-2px]">legendary</span> cards, Start Collecting</h1>
      ...
      <Image src="/img1.png" alt="Picture drawing of 2 people playing cards." draggable={false} height={400} width={600} />
    </div>
  );
}
